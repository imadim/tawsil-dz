...
- تطبيق هاتف قابل للتثبيت (PWA) مع إشعارات فورية عند تغيّر حالة الطلب
...
الموقع تطبيق ويب تقدّمي (PWA):

1. افتح الرابط من متصفح الهاتف (Chrome على أندرويد، Safari على آيفون)
2. اضغط زر **«ثبّت التطبيق»** الأخضر أسفل الشاشة — أو من قائمة المتصفح: «إضافة إلى الشاشة الرئيسية»
3. يظهر كأيقونة مستقلة، ويفتح بملء الشاشة بلا شريط عنوان

عند أول ضغطة داخل التطبيق يطلب إذن الإشعارات؛ بعدها يصل إشعار لكل تغيّر في حالة الطلب.
